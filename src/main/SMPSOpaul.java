 ...
 */
public class SMPSOpaul extends Algorithm {
   ...
   */
  public SMPSOpaul(Problem problem) {
    super(problem) ;
   ...
   * @param problem Problem to solve
   */
  public SMPSOpaul(Problem problem, String trueParetoFront) throws FileNotFoundException {
    super(problem) ;
    hy_ = new Hypervolume();
    jmetal.qualityIndicator.util.MetricsUtil mu = new jmetal.qualityIndicator.util.MetricsUtil();
    trueFront_ = mu.readNonDominatedSolutionSet(trueParetoFront);
  ...
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    ...
    while (iteration_ < maxIterations_ && !isConvergent()) {
      try {
        ...
        Logger.getLogger(SMPSOpaul.class.getName()).log(Level.SEVERE, null, ex);
      }
